...
export default function AboutUs() {
  return (
    <section className="w-full bg-soft-sand py-24 px-6 lg:px-[35px] relative z-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">

        {/* Left: Text Content */}
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
          <h2 className="font-moniqa text-[clamp(40px,8vw,80px)] text-primary-text leading-[0.9] m-0 p-0 mb-8">
            Наш опыт — <br />
            ваше спокойствие
          </h2>

          <p className="font-century-gothic text-[clamp(16px,2vw,24px)] text-secondary-text leading-[1.6] m-0 p-0 mb-10 max-w-[540px]">
          ...
          <button className="flex items-center justify-center border border-evergreen-forest bg-evergreen-forest text-soft-sand font-century-gothic text-[clamp(16px,2vw,20px)] rounded-[26px] hover:bg-[#1F3520] hover:border-[#1F3520] transition-colors duration-200 px-8 py-3 min-w-[220px]">
            Наши стандарты
          </button>
        </div>

        {/* Right: Image Placeholder */}
        <div className="w-full lg:w-1/2 relative aspect-[4/5] lg:aspect-[4/3] rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-[#2E4B2F]/5 transition-shadow duration-500">
