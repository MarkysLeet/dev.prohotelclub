      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        {variant === 'collection' ? (
          <div className="mt-auto pt-4 border-t border-gray-100 flex flex-row items-center justify-between gap-2 flex-wrap">
            <Link href={hotel.link || `/hotels/${('slug' in hotel ? (hotel as unknown as {slug: string}).slug : hotel.id)}`} className="text-evergreen-forest text-sm font-medium flex items-center gap-2 hover:opacity-80 transition-opacity">
              Подробнее
            </Link>
          ...
          <div className="mt-auto pt-4 border-t border-gray-100">
            <Link href={hotel.link || `/hotels/${('slug' in hotel ? (hotel as unknown as {slug: string}).slug : hotel.id)}`}>
